...
import { contasPublicasDocuments } from "../data/mockData";
          ...
          <div className="flex items-center space-x-4 mb-4">
            ...
            <div>
              ...
              <p className="text-neutral-300 mt-2">
                Orçamento, execução fiscal e documentos contábeis
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          ...
          <div className="mt-6 bg-blue-50 border border-blue-200 p-4">
            <p className="text-sm text-blue-900">
              <strong className="font-mono">Lei de Responsabilidade Fiscal (LC 101/2000):</strong> Os documentos
              RREO e RGF são obrigatórios e devem ser publicados bimestralmente e quadrimestralmente, respectivamente.
            </p>
          </div>
        </div>
      </div>
