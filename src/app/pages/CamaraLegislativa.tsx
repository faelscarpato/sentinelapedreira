...
import { camaraDocuments } from "../data/mockData";
      ...
      <div className="bg-neutral-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center space-x-4 mb-4">
            ...
            <div>
              <h1 className="text-3xl font-mono">Câmara Legislativa</h1>
              <p className="text-neutral-300 mt-2">
                Projetos de lei, moções, requerimentos e documentos legislativos
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {filteredDocuments.length === 0 && (
          <div className="text-center py-20">
            <Scale className="w-16 h-16 text-neutral-300 mx-auto mb-4" />
